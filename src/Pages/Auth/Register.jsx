...
const Register = () => {
  ...
  return (
    <div className="max-w-sm mx-auto mt-20 p-5 border shadow-lg rounded-lg">
      ...
      <button onClick={handleGoogleSignIn} className="btn w-full mt-2 flex items-center justify-center gap-2">
