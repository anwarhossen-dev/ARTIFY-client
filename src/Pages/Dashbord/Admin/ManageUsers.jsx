...
const ManageUsers = () => {
  ...
  useEffect(() => {
    axios
      .get(`${import.meta.env.VITE_API_URL || "https://artify-server-six.vercel.app"}/users`)
      .then((res) => {
        setUsers(res.data);
  ...
  const handleDeleteUser = async (userId) => {
    if (window.confirm("Are you sure you want to delete this user?")) {
      try {
        await axios.delete(`${import.meta.env.VITE_API_URL || "https://artify-server-six.vercel.app"}/users/${userId}`);
