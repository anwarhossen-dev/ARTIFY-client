...
const Navbar = () => {
  ...
  // Private links (only when user is logged in)
  ...
  return (
    <div className="bg-gray-900 text-white sticky top-0 z-[9999] shadow-lg">
      <div className="w-11/12 mx-auto flex justify-between items-center py-3 px-2">
        ...
        <div className="flex items-center gap-6">
          ...
          <div className="dropdown">
            ...
            <ul className="menu menu-sm dropdown-content bg-[#B6AE9F] text-[#062941] font-bold rounded-box mt-3 w-64 p-4 shadow z-50 space-y-2">
              {publicLinks}
              {privateLinks}
            </ul>
          </div>
          ...
          {/* Logo */}
          <Link to="/" className="font-extrabold text-3xl flex items-end">
            <span className="text-[#9B5DE0]">A</span>
        ...
        <div className="hidden lg:flex">
          <ul className="flex gap-6 px-1 text-lg font-medium">
            {publicLinks}
            {privateLinks}
          </ul>
        </div>
          ...
          {user ? (
            <div className="dropdown dropdown-end dropdown-hover">
              <div tabIndex={0} className="cursor-pointer">
                <img
                  className="w-12 h-12 rounded-full ring-4 ring-purple-500 ring-offset-2 ring-offset-gray-900"
                  src={user.photoURL}
              ...
              <ul className="dropdown-content menu p-4 shadow bg-[#a09d97] text-[#062941] rounded-box z-50 w-64 space-y-4">
                {/* Theme Toggle */}
                ...
                <li className="border-t pt-3">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="font-bold">{user.displayName || "Artist"}</p>
                ...
                <li>
                  <MyLink to="/dashboard" className="btn btn-outline btn-primary w-full">
                    Go to Dashboard
                  </MyLink>
                </li>
            ...
            <div className="flex gap-4">
              <Link to="/auth/login" className="btn btn-outline btn-primary font-bold">
                Log In
              </Link>
              <Link to="/auth/register" className="btn btn-primary font-bold">
                Register
              </Link>
            </div>
          )}
